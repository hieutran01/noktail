                ...
                <li>
                    ...
                    <div class="bg-white shadow-sm rounded-lg uk-transition-toggle md:flex">
                        ...
                        <div class="flex-1 md:p-6 p-4">
                            <div class="font-semibold line-clamp-2 md:text-xl md:leading-relaxed">Learn How
                                to Build Responsive Web Design Essentials HTML5 CSS3 and Bootstrap </div>
                            <div class="mt-2 md:block hidden">
                                <p class="line-clamp-2">Lorem ipsum dolor sit amet, consectetuer adipiscing
                            ...
                            <a href="course-intro.html" class="uk-link-reset">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="font-semibold line-clamp-2"> Learn JavaScript and
                                            Express to become a professional JavaScript developer. </div>
                        ...
                        <li>
                            ...
                            <a href="course-intro.html" class="uk-link-reset">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="font-semibold line-clamp-2">Learn Angular Fundamentals
                                            From beginning to advance </div>
                                        <div class="flex space-x-2 items-center text-sm pt-3">
                                            <div> 26 hours </div>
                                            <div>·</div>
                                            <div> 26 lectures </div>
                        ...
                        <li>
                            ...
                            <a href="course-intro.html" class="uk-link-reset">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="font-semibold line-clamp-2">Responsive Web Design
                                            Essentials HTML5 CSS3 Bootstrap </div>
                                        <div class="flex space-x-2 items-center text-sm pt-3">
                                            <div> 18 hours </div>
                                            <div>·</div>
                                            <div> 42 lectures </div>
        ...
        <div class="uk-slider-container px-1 py-3">
            <ul
                ...
                <li>
                    <div class="card">
                        <a href="book-description.html">
                            <img src="{{asset('assets/images/book/book4.jpg')}}" alt=""
                ...
                <li>
                    <div class="card">
                        <a href="book-description.html">
                            <img src="{{asset('assets/images/book/book5.jpg')}}" alt=""
                                class="w-full h-52 object-cover">
                ...
                <li>
                    <div class="card">
                        <a href="book-description.html">
                            <img src="{{asset('assets/images/book/book1.jpg')}}" alt=""
                                class="w-full h-52 object-cover">
                ...
                <li>
                    <div class="card">
                        <a href="book-description.html">
                            <img src="{{asset('assets/images/book/book2.jpg')}}" alt=""
                                class="w-full h-52 object-cover">
                ...
                <li>
                    <div class="card">
                        <a href="book-description.html">
                            <img src="{{asset('assets/images/book/book3.jpg')}}" alt=""
                                class="w-full h-52 object-cover">
            ...
            <div class="uk-slider-container md:px-1 px-2 py-3">
                <ul class="uk-slider-items uk-child-width-1-3@m uk-child-width-1-2 uk-grid-small uk-grid">
                    <li>
                        <a href="episodes-watch.html">
                            <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                <img src="{{asset('assets/images/episodes/img-2.jpg')}}" alt=""
                                    class="w-full h-full absolute inset-0 object-cover">
                                <span
                    ...
                    <li>
                        <a href="episodes-watch.html">
                            <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                <img src="{{asset('assets/images/episodes/img-4.jpg')}}" alt=""
                                    class="w-full h-full absolute inset-0 object-cover">
                                <span
                                    class="absolute bottom-2 right-2 px-2 py-1 text-xs font-semibold bg-black bg-opacity-50 text-white rounded">
                                    12:21</span>
                    ...
                    <li>
                        <a href="episodes-watch.html">
                            <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                <img src="{{asset('assets/images/episodes/img-1.jpg')}}" alt=""
                                    class="w-full h-full absolute inset-0 object-cover">
                                <span
                                    class="absolute bottom-2 right-2 px-2 py-1 text-xs font-semibold bg-black bg-opacity-50 text-white rounded">
                                    12:21</span>
                    ...
                    <li>
                        <a href="episodes-watch.html">
                            <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                <img src="{{asset('assets/images/episodes/img-3.jpg')}}" alt=""
                                    class="w-full h-full absolute inset-0 object-cover">
                                <span
                                    class="absolute bottom-2 right-2 px-2 py-1 text-xs font-semibold bg-black bg-opacity-50 text-white rounded">
                                    12:21</span>
                        ...
                        <div class="pt-3">
                            <a href="episodes-watch.html" class="font-semibold line-clamp-2"> Creating
                                sticky in HTML </a>
                ...
                <a class="absolute bg-white top-16 flex items-center justify-center p-2 -left-4 rounded-full shadow-md text-xl w-9 z-10 dark:bg-gray-800 dark:text-white"
                    href="#" uk-slider-item="previous"> <ion-icon name="chevron-back-outline"></ion-icon>
                </a>
