            ...
            <div class="container">
                ...
                <div class="lg:flex lg:space-x-4 lg:-mx-4 mt-6">
                        ...
                        <div class="divide-y tube-card px-6 md:m-0 -mx-5 py-2">
                            ...
                            <div class="md:flex md:space-x-6 py-5">
                                ...
                                <div class="flex-1 md:pt-0 pt-4"> 
                                    ...
                                    <div class="flex items-center pt-2 text-sm">
                                        <div class="flex items-center">  <ion-icon name="thumbs-up-outline" class="text-xl mr-2 md hydrated" role="img" aria-label="thumbs up outline"></ion-icon>  12 </div>
                                        <div class="flex items-center mx-4"> 
                                            <ion-icon name="chatbubble-ellipses-outline" class="text-lg mr-2 md hydrated" role="img" aria-label="chatbubble ellipses outline"></ion-icon>  12 
                                        </div>
                                        <div class="flex items-center"> <ion-icon name="bookmark-outline" class="text-xl mr-2 md hydrated" role="img" aria-label="bookmark outline"></ion-icon>  </div>
                                    </div>
                            ...
                            <div class="md:flex md:space-x-6 py-5">
                                ...
                                <div class="flex-1 md:pt-0 pt-4"> 
                                    ...
                                    <div class="flex items-center pt-2 text-sm">
                                        <div class="flex items-center">  <ion-icon name="thumbs-up-outline" class="text-xl mr-2 md hydrated" role="img" aria-label="thumbs up outline"></ion-icon>  43 </div>
                                        <div class="flex items-center mx-4"> 
                                            <ion-icon name="chatbubble-ellipses-outline" class="text-lg mr-2 md hydrated" role="img" aria-label="chatbubble ellipses outline"></ion-icon>  12 
                                        </div>
                                        <div class="flex items-center"> <ion-icon name="bookmark-outline" class="text-xl mr-2 md hydrated" role="img" aria-label="bookmark outline"></ion-icon> </div>
                            ...
                            <div class="md:flex md:space-x-6 py-5">
                                ...
                                <div class="flex-1 md:pt-0 pt-4"> 
                                    ...
                                    <div class="flex items-center pt-2 text-sm">
                                        <div class="flex items-center">  <ion-icon name="thumbs-up-outline" class="text-xl mr-2 md hydrated" role="img" aria-label="thumbs up outline"></ion-icon>  32 </div>
                                        <div class="flex items-center mx-4"> 
                                            <ion-icon name="chatbubble-ellipses-outline" class="text-lg mr-2 md hydrated" role="img" aria-label="chatbubble ellipses outline"></ion-icon>  18 
                                        </div>
                                        <div class="flex items-center"> <ion-icon name="bookmark-outline" class="text-xl mr-2 md hydrated" role="img" aria-label="bookmark outline"></ion-icon>  </div>
                                    </div>
                            ...
                            <div class="md:flex md:space-x-6 py-5">
                                ...
                                <div class="flex-1 md:pt-0 pt-4"> 
                                    ...
                                    <div class="flex items-center pt-2 text-sm">
                                        <div class="flex items-center">  <ion-icon name="thumbs-up-outline" class="text-lg mr-2 md hydrated" role="img" aria-label="thumbs up outline"></ion-icon>  32 </div>
                                        <div class="flex items-center mx-4"> 
                                            <ion-icon name="chatbubble-ellipses-outline" class="text-lg mr-2 md hydrated" role="img" aria-label="chatbubble ellipses outline"></ion-icon>  34 
                                        </div>
                                        <div class="flex items-center"> <ion-icon name="bookmark-outline" class="text-lg mr-2 md hydrated" role="img" aria-label="bookmark outline"></ion-icon>  </div>
                                    </div>
                    ...
                    <div class="lg:w-80 w-full">
                        ...
                        <div class="space-y-5 uk-sticky" uk-sticky="offset:22; bottom:true ; top:30 ; animation: uk-animation-slide-top-small">
                        ...
                        </div><div class="uk-sticky-placeholder" hidden="" style="height: 626px; margin: 0px;"></div>
