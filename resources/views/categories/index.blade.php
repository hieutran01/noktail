                    ...
                    <div class="grid lg:grid-cols-3 md:grid-cols-2 md:gap-4 gap-2 -m-3">
                        <a href="#">
                            <div class="hover:bg-gray-100 flex items-start px-3 py-2 rounded-lg space-x-3">
                                <ion-icon name="logo-angular" class="text-3xl text-white from-red-600 to-red-400 bg-gradient-to-tl p-2 rounded-md md hydrated" role="img" aria-label="logo angular"></ion-icon>
                                <div>
                        ...
                        <a href="#">
                            <div class="hover:bg-gray-100 flex items-start px-3 py-2 rounded-lg space-x-3">
                                <ion-icon name="briefcase" class="text-3xl text-white from-blue-600 to-blue-400 bg-gradient-to-tl p-2 rounded-md md hydrated" role="img" aria-label="briefcase"></ion-icon>
                                <div>
                        ...
                        <a href="#">
                            <div class="hover:bg-gray-100 flex items-start px-3 py-2 rounded-lg space-x-3">
                                <ion-icon name="color-wand" class="text-3xl text-white from-purple-600 to-purple-400 bg-gradient-to-tl p-2 rounded-md md hydrated" role="img" aria-label="color wand"></ion-icon>
                                <div>
                        ...
                        <a href="#">
                            <div class="hover:bg-gray-100 flex items-start px-3 py-2 rounded-lg space-x-3">
                                <ion-icon name="shield-checkmark" class="text-3xl text-white from-yellow-600 to-yellow-400 bg-gradient-to-tl p-2 rounded-md md hydrated" role="img" aria-label="shield checkmark"></ion-icon>
                                <div>
                        ...
                        <a href="#">
                            <div class="hover:bg-gray-100 flex items-start px-3 py-2 rounded-lg space-x-3">
                                <ion-icon name="leaf" class="text-3xl text-white from-green-600 to-green-400 bg-gradient-to-tl p-2 rounded-md md hydrated" role="img" aria-label="leaf"></ion-icon>
                                <div>
                        ...
                        <a href="#">
                            <div class="hover:bg-gray-100 flex items-start px-3 py-2 rounded-lg space-x-3">
                                <ion-icon name="logo-figma" class="text-3xl text-white from-pink-600 to-pink-400 bg-gradient-to-tl p-2 rounded-md md hydrated" role="img" aria-label="logo figma"></ion-icon>
                                <div>
