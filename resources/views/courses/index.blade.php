                            ...
                            <div class="uk-slider-container px-1 py-3">
                                ...
                                <ul class="uk-slider-items uk-child-width-1-3@m uk-child-width-1-2@s uk-grid-small uk-grid" style="transform: translate3d(0px, 0px, 0px);">
                                    ...
                                    <li tabindex="-1" class="uk-active">
                                        ...
                                        <a href="{{ route('courses.show')}}" class="uk-link-reset">
                            ...
                            <ul class="uk-slider-items uk-child-width-1-5@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid" style="transform: translate3d(0px, 0px, 0px);">
                                <li tabindex="-1" class="uk-active">
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="{{asset('assets/images/category/design.jpg')}}" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li tabindex="-1" class="uk-active">
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="{{asset('assets/images/category/marketing.jpg')}}" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li tabindex="-1" class="uk-active">
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="{{asset('assets/images/category/it-and-software.jpg')}}" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li tabindex="-1" class="uk-active">
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="{{asset('assets/images/category/music.jpg')}}" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li tabindex="-1" class="">
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="{{asset('assets/images/category/business.jpg')}}" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li tabindex="-1">
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="{{asset('assets/images/category/development.jpg')}}" class="absolute w-full h-full object-cover" alt="">
                    ...
                    <div class="md:flex justify-between items-center mb-8 pt-4 border-t">
                        ...
                        <div class="flex items-center justify-end">
                            ...
                            <div class="bg-gray-100 border inline-flex p-0.5 rounded-md text-lg self-center">
                                <a href="courses-list.html" class="py-1.5 px-2.5 rounded-md" data-tippy-placement="top" data-tippy="" data-original-title="List view"> 
                                ...
                                <a href="#" class="py-1.5 px-2.5 rounded-md bg-white shadow" data-tippy-placement="top" data-tippy="" data-original-title="Grid view"> 
                            ...
                            <a href="#" class="bg-gray-100 border ml-2 px-3 py-2 rounded-md" data-tippy-placement="top" uk-toggle="target: #course-filter;flip: true" data-tippy="" data-original-title="Filter"> 
